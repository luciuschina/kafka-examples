...
public class KafkaStreamWordCount {
    public static void main(String[] args) {
       /* final String bootstrapServers = args.length > 0 ? args[0] : "192.168.70.11:9092";
        ...
        final KStream<String, String> textLines = kStreamBuilder.stream(stringSerde, stringSerde, "TextLinesTopic");
       ...
       // wordCounts.to(stringSerde, longSerde, "WordsWithCountsTopic");
        ...
        final KafkaStreams streams = new KafkaStreams(kStreamBuilder, streamsConfiguration);
